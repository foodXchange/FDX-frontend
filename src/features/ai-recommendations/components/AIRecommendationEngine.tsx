...
import { Box, Grid, Paper, Typography, Card, CardContent, CardHeader, CardMedia, CardActions, Avatar, Chip, Button, IconButton, Stack, Tab, Tabs, Badge, Slider, Switch, FormControlLabel, TextField, InputAdornment, Dialog, DialogTitle, DialogContent, Alert, AlertTitle, LinearProgress, Divider, useTheme, alpha, Collapse,  } from '@mui/material';
import { AutoAwesome, TrendingUp, Psychology, Lightbulb, ThumbUp, ThumbDown, Refresh, ExpandMore, Search, Store, ShoppingCart, CompareArrows, Timeline, Speed, Close, BookmarkBorder, Bookmark, Share, SwapHoriz, TuneRounded, SmartToy, Insights,  } from '@mui/icons-material';
import { motion, AnimatePresence } from 'framer-motion';
import { format } from 'date-fns';
import { AreaChart, Area, RadarChart, Radar, PolarGrid, PolarAngleAxis, PolarRadiusAxis, XAxis, YAxis, CartesianGrid, ResponsiveContainer,  } from 'recharts';
