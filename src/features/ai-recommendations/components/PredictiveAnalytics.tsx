...
import { Box, Grid, Paper, Typography, Card, CardContent, CardHeader, CardActions, Button, IconButton, Stack, Chip, Avatar, Alert, AlertTitle, Tabs, Tab, List, ListItem, ListItemIcon, ListItemText, FormControl, InputLabel, Select, MenuItem, LinearProgress, useTheme, alpha,  } from '@mui/material';
import { Timeline, TrendingUp, TrendingDown, Analytics, Insights, Inventory, Lightbulb, AutoAwesome, Psychology, Assessment, ShowChart, Refresh, Share, Bookmark, BookmarkBorder, MoreVert, Settings, AttachMoney,  } from '@mui/icons-material';
