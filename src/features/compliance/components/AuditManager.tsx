...
import { Box, Grid, Paper, Typography, Card, CardContent, CardHeader, CardActions, Button, IconButton, Stack, Chip, Avatar, Dialog, DialogTitle, DialogContent, DialogActions, TextField, FormControl, InputLabel, Select, MenuItem, Tabs, Tab, Collapse, LinearProgress, useTheme, alpha,  } from '@mui/material';
import { Assignment, Person, Schedule, CheckCircle, Add, Edit, Delete, Visibility, Download, CalendarToday, AccessTime, LocationOn, Business, Assessment, Flag, Report, Cancel, PlayArrow, Pause, ExpandMore, ExpandLess, DocumentScanner,  } from '@mui/icons-material';
