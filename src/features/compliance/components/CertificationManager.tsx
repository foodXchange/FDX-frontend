...
import { Box, Grid, Paper, Typography, Card, CardContent, CardHeader, CardActions, Button, IconButton, Stack, Chip, Avatar, Dialog, DialogTitle, DialogContent, TextField, FormControl, InputLabel, Select, MenuItem, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Stepper, Step, StepLabel, StepContent, Alert, AlertTitle, List, ListItem, ListItemIcon, ListItemText, Tabs, Tab, LinearProgress, useTheme, alpha,  } from '@mui/material';
import { VerifiedUser, Assignment, CloudUpload, Schedule, Warning, CheckCircle, Refresh, Download, Add, Edit, Delete, Visibility, History, Assessment, Business, LocationOn, Phone, PendingActions, Block,  } from '@mui/icons-material';
