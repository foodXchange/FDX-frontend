...
import { Box, Grid, Paper, Typography, Card, CardContent, CardHeader, Button, IconButton, Stack, Chip, Avatar, List, ListItem, ListItemIcon, ListItemText, ListItemSecondaryAction, Badge, Tabs, Tab, useTheme, alpha,  } from '@mui/material';
import { Dashboard, VerifiedUser, Assignment, Warning, CheckCircle, TrendingUp, TrendingDown, Assessment, Flag, Gavel, Rule, CalendarToday, Download, Refresh, Settings, Timeline, Report, MoreVert, TrendingFlat,  } from '@mui/icons-material';
import { motion, AnimatePresence } from 'framer-motion';
import { format } from 'date-fns';
import { LineChart, Line, XAxis, YAxis, CartesianGrid, ResponsiveContainer, Cell, PieChart, Pie, Legend,  } from 'recharts';
